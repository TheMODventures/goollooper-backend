...
const indexRule = yup.object().shape({
    ...
    query: yup
        ...
        type: yup
            .string()
            .oneOf(Object.values(enums_1.EGUIDELINE).map((e) => e.toString()))
            .notRequired(),
    })
        .noUnknown(),
});
const createRule = yup.object().shape({
    ...
    body: yup
        ...
        type: yup
            .number()
            .oneOf(Object.values(enums_1.EGUIDELINE).map((e) => Number(e)))
            .required(),
    })
        .noUnknown(),
...
//# sourceMappingURL=guideline.validate.js.map